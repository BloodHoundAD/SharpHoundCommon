    ...
    public static class WellKnownPrincipal
    {
        ...
        public static bool GetWellKnownPrincipal(string sid, out TypedPrincipal commonPrincipal)
        {
            commonPrincipal = sid switch
            {
                ...
                "S-1-3-1" => new TypedPrincipal("Creator Label.Group", Label.Group),
                "S-1-3-2" => new TypedPrincipal("Creator Owner Server", Label.Computer),
                "S-1-3-3" => new TypedPrincipal("Creator Label.Group Server", Label.Computer),
                ...
                "S-1-5-11" => new TypedPrincipal("Authenticated Label.Users", Label.Group),
                "S-1-5-12" => new TypedPrincipal("Restricted Code", Label.Group),
                "S-1-5-13" => new TypedPrincipal("Terminal Server Label.Users", Label.Group),
                ...
                "S-1-5-114" => new TypedPrincipal("Local Account and Member of Administrators Label.Group", Label.User),
                "S-1-5-80-0" => new TypedPrincipal("All Services ", Label.Group),
                "S-1-5-32-544" => new TypedPrincipal("Administrators", Label.Group),
                "S-1-5-32-545" => new TypedPrincipal("Label.Users", Label.Group),
                "S-1-5-32-546" => new TypedPrincipal("Guests", Label.Group),
                "S-1-5-32-547" => new TypedPrincipal("Power Label.Users", Label.Group),
                ...
                "S-1-5-32-555" => new TypedPrincipal("Remote Desktop Label.Users", Label.Group),
                ...
                "S-1-5-32-558" => new TypedPrincipal("Performance Monitor Label.Users", Label.Group),
                "S-1-5-32-559" => new TypedPrincipal("Performance Log Label.Users", Label.Group),
                "S-1-5-32-560" => new TypedPrincipal("Windows Authorization Access Label.Group", Label.Group),
                "S-1-5-32-561" => new TypedPrincipal("Terminal Server License Servers", Label.Group),
                "S-1-5-32-562" => new TypedPrincipal("Distributed COM Label.Users", Label.Group),
                ...
                "S-1-5-32-580" => new TypedPrincipal("Remote Management Label.Users", Label.Group),
                _ => null
            };
