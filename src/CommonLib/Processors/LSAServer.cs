...
namespace SharpHoundCommonLib.Processors
{
    public class LSAServer : IDisposable
    {
        ...
        public LSAServer(string computerName, ILDAPUtils utils = null, NativeMethods methods = null, ILogger log = null)
        {
            ...
            var status = _nativeMethods.CallLSAOpenPolicy(ref us, ref _obj,
        ...
        /// <summary>
        ///     Reads principals granted the specified privilege. Refer to <see cref="LSAPrivileges" /> for a list of relevant
        ///     privileges.
        /// </summary>
        ...
        public IEnumerable<string> ReadLSAPrivilege(string privilege)
        {
            ...
            _log.LogTrace(
                $"LSAEnumerateAccountsWithUserRight returned {count} objects for privilege {privilege} on {_computerName}");
            ...
            foreach (var sid in sids) yield return sid;
        }
    }
}