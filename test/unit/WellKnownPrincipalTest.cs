    ...
    public class WellKnownPrincipalTest : IDisposable
    {
        ...
        public static (string sid, string name, Label label)[] GetWellKnownPrincipals()
        {
            return new (string sid, string name, Label label)[64]
            {
                ...
                ("S-1-3-3","Creator Label.Group Server", Label.Computer),
                ...
                ("S-1-5-11","Authenticated Label.Users", Label.Group),
                ("S-1-5-12","Restricted Code", Label.Group),
                ("S-1-5-13","Terminal Server Label.Users", Label.Group),
                ...
                ("S-1-5-114","Local Account and Member of Administrators Label.Group", Label.User),
                ("S-1-5-80-0","All Services ", Label.Group),
                ("S-1-5-32-544","Administrators", Label.Group),
                ("S-1-5-32-545","Label.Users", Label.Group),
                ...
                ("S-1-5-32-555","Remote Desktop Label.Users", Label.Group),
                ("S-1-5-32-556","Network Configuration Operators", Label.Group),
                ("S-1-5-32-557","Incoming Forest Trust Builders", Label.Group),
                ("S-1-5-32-558","Performance Monitor Label.Users", Label.Group),
                ("S-1-5-32-559","Performance Log Label.Users", Label.Group),
                ("S-1-5-32-560","Windows Authorization Access Label.Group", Label.Group),
                ("S-1-5-32-561","Terminal Server License Servers", Label.Group),
                ("S-1-5-32-562","Distributed COM Label.Users", Label.Group),
                ...
                ("S-1-5-32-580","Remote Management Label.Users", Label.Group)
            };
        }
        #endregion
